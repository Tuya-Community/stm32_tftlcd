...
//电阻屏芯片连接引脚	   	
#define PEN      HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_1)      //PB1  INT
#define DOUT     HAL_GPIO_ReadPin(GPIOB, GPIO_PIN_2)     	//PB2  MISO
#define TDIN(x)  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_5, x);  //PB5  MOSI
#define TCLK(x)  HAL_GPIO_WritePin(GPIOB,GPIO_PIN_11, x); //PB11 SCLK
#define TCS(x)   HAL_GPIO_WritePin(GPIOB,GPIO_PIN_13,x);  //PB13 CS 
