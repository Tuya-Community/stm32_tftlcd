...
//支持驱动IC型号包括:
//ILI9341/ILI9325/RM68042/RM68021/ILI9320/ILI9328/LGDP4531/LGDP4535/
...
{										   
	...
	GPIOC->MODER=0X00000000;//输入
	GPIOC->PUPDR=0X55555555;//上拉
...
{ 	
 ...
 //GPIO_PinRemapConfig(GPIO_Remap_SWJ_JTAGDisable , ENABLE);//开启SWD，失能JTAG
	...
	GPIO_InitStruct.Pin = GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_12;	   ///PORTA7~12推挽输出
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_HIGH;
	HAL_GPIO_Init(GPIOA, &GPIO_InitStruct); //GPIOA	
	HAL_GPIO_WritePin(GPIOA,GPIO_PIN_7|GPIO_PIN_11|GPIO_PIN_12,GPIO_PIN_SET);

	GPIO_InitStruct.Pin = GPIO_PIN_10|GPIO_PIN_12;	   ///PORTB10~PORTB12复用推挽输出
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_HIGH;
	...
	GPIO_InitStruct.Pin = GPIO_PIN_All;	//  PORTC推挽输出
  ...
  lcddev.id = LCD_ReadReg(0x0000); 
	...
	LCD_LED_SET;				
	//HAL_GPIO_WritePin(LCD_LED_GPIO_Port,GPIO_PIN_10,GPIO_PIN_SET);//点亮背光
	LCD_LED_SET;
	LCD_Clear(WHITE);
}  		  
